...
<html lang="en">
	...
	<head>
		<meta charset="utf-8"/>
		<title>Measurement - Hemisphere</title>
		...
		<div class="full">
			...
			<section class="subpage_main_side">
				...
				<article>
					<div class="material">
						<header>
							<h2><center>Hemisphere</center><br/></h2>
						</header>
								...
								<?php
									if(!empty($_POST['radious'])&&isset($_POST['radious'])){
										if(is_numeric($_POST['radious'])){
											...
											echo '&nbsp&nbsp Total Surface Area of Hemisphere = ',$area,'<br/>';
											echo '&nbsp&nbsp<span class="result">Formula = ________ </span><br/><br/>';
											
											echo '&nbsp&nbsp Curved Surface Area of Hemisphere = ',$curved_area,'<br/>';
											echo '&nbsp&nbsp<span class="result">Formula =_________ </span><br/><br/>';
											
											echo '&nbsp&nbsp Volume of Hemisphere = ',$volume,'<br/>';
				...
				<img src="../pic/hemisphere.jpg" class="pic_place">
